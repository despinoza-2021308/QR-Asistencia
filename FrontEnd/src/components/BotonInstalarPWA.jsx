    ...
    return (
        <>
            <button
                type="button"
                onClick={handleClick}
                className={`inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-teal-500/25 via-cyan-500/25 to-blue-500/25 hover:from-teal-500/35 hover:to-blue-500/35 border border-cyan-400/40 shadow-lg shadow-cyan-950/50 backdrop-blur-md transition-all active:scale-95 min-h-[42px] cursor-pointer ${className}`}
                title="Instalar ONE Consulting en tu pantalla de inicio"
            >
                <div className="w-5 h-5 rounded-lg bg-cyan-400/20 border border-cyan-400/30 flex items-center justify-center shrink-0">
